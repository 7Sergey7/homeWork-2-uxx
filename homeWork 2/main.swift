...
let offset = str.index(str.startIndex, offsetBy: str.count / 2)
...
let newIndex  = str1.startIndex

let strMidle = str1.count / 2

str1.remove(at: str1.index(newIndex, offsetBy: strMidle))
